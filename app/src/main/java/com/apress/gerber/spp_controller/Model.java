...
public class Model {
    ...
    public void movemodel(float px,float py ,float pz){
        ...
        maxX+=px;minX+=px;maxY+=py;minY+=py;
        maxZ+=pz;minZ=+pz;
        vertBuffer = null;
    ...
    {
        int i;
        for(i=2;i<=facetCount*9-1;i=i+3){verts[i]=maxZ+minZ-verts[i];}
    }

    public void reY()
    {
        int i;
        for(i=1;i<=facetCount*9-2;i=i+3){verts[i]=maxY+minY-verts[i];}
    }

    public void reX()
    {
        int i;
        for(i=0;i<=facetCount*9-3;i=i+3){verts[i]=maxX+minX-verts[i];}
    }
